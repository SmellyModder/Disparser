...
public final class GuildMessageCommandContext extends CommandContext<GuildMessageReceivedEvent> {
	...
	public GuildMessageCommandContext(GuildMessageReceivedEvent event, List<ParsedArgument<?>> parsedArguments, CommandPropertyMap.PropertyMap propertyMap, FeedbackHandler feedbackHandler, BuiltInExceptionProvider exceptionProvider) {
